...
function App() {
  return (
      <div style={{textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
        <div style={{ height: "20px",  width: "64px", paddingTop: "34px"}}>
          <p>logo</p>
        </div>
        
        <div style={{ paddingTop: "96px" }}>
          <h1>Cyber ink</h1>
          <p>Is a collection of 10,000 on the blockchain.<br/>
            What’s more, each Cyber ink unlocks NEST Fi membership<br/>
            and additional benefits the longer you hold them.</p>
        </div>
        
        <div style={{ height: "465px", width: "100%", background: "red", marginTop: "67px" }}>
        ...
        <div>
          ...
          <p>The overall setting is in the year 3241, when the galactic horizon has been opened<br/>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "104px" }}>
          <div style={{ width: "230px", height: "260px", background: "red", marginBottom: "24px" }}>
          
          </div>
          <h2>Six People Club</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "104px" }}>
          <div style={{ width: "271px", height: "265px", background: "red", marginBottom: "24px" }}>
  
          </div>
          <h2>The story of Earth</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "104px" }}>
          <div style={{ width: "265px", height: "229px", background: "red", marginBottom: "24px" }}>
    
          </div>
          <h2>The story of Planet X</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "104px" }}>
          <div style={{ width: "271px", height: "230px", background: "red", marginBottom: "24px" }}>
    
          </div>
          <h2>The story of Galaxy Z</h2>
          <p>After around 200 years, the AI arrived in a galaxy most suited for massenergy<br/>
            ...
            AIs that inhabited each of the 100 billion worlds. A Soul Chip, based on its attachment to the Earth, <br/>
        ...
        <div style={{ height: "580px", marginTop: '138px', display: "flex", flexDirection: "column", justifyContent: "center", background:"white", width: "100%", alignItems: "center"}}>
          <h1>NFT Shop</h1>
          <div style={{ display: "flex", marginTop: "44px"}}>
            <div style={{ marginRight: "200px" }}>
              <div style={{ width: "94px", height: "94px", background: "red" }}>
        ...
        <div style={{ paddingTop: "138px", paddingBottom: "138px", }}>
          ...
          <p>Second round of 3000 NFT (bsc):
          </p>
        </div>
      </div>
  );
